...
interface OAuthServerServiceInterface
{
     ...
     */
    function requestToken($requestParameters, $requestMethod, $requestUrl);
    /**
     ...
     */
    function authorize($oauthToken, $oauthCallback = null);
    /**
     ...
     */
    function accessToken($requestParameters, $requestMethod, $requestUrl);
    /**
     ...
     * @return boolean
     */
    function validateRequest($requestParameters, $requestMethod, $requestUrl);
}
